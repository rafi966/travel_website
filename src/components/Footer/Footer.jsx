    ...
    <footer className="footer">
      <Container>
        <Row>
          ...
          <div className="logo">
          <img src={logo} alt="" />
          <p>"Travel far enough, you meet yourself.
...
<ListGroup className='footer__quick-links'>
    ...
    <p className='mb-0'>Kadapa, India</p>
      </ListGroupItem>
    ...
    <p className='mb-0'>shaikmahammedrafi966@gmail.com</p>
      </ListGroupItem>
      <ListGroupItem className='ps-0 border-0 d-flex align-items-center gap-3'>
    <h6 className='mb-0 d-flex align-items-center gap-2'>
    ...
    <p className='mb-0'>+917799191121</p>
      </ListGroupItem>
</ListGroup>
          </Col>
          <Col lg='12' className='text-center pt-5'>
          <p className='copyright'>
            Copyright {year}, designed and developed with love ❤️ by rafi </p>
          </Col>
        </Row>
      </Container>
    </footer>
